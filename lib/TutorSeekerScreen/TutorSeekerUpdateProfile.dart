...
class TutorSeekerUpdateProfile extends StatefulWidget {
  ...
  const TutorSeekerUpdateProfile({
    super.key,
  ...
  @override
  State<TutorSeekerUpdateProfile> createState() =>
      _TutorSeekerUpdateProfileState();
}

class _TutorSeekerUpdateProfileState extends State<TutorSeekerUpdateProfile> {
  ...
  late TextEditingController _requirementController = TextEditingController();
  ...
  void initState() {
    ...
    _requirementController = TextEditingController(text: widget.requirement);
    _grade = widget.grade!;
